...
if [ ! -f "cloudflare.sh" ];then
    wget https://github.com/linsir/pyscripts/raw/master/le-dns/cloudflare.sh -O cloudflare.sh -o /dev/null
    chmod +x cloudflare.sh
fi

if [ ! -f "cloudflare-hook.sh" ];then
    wget https://github.com/linsir/pyscripts/raw/master/le-dns/cloudflare-hook.sh -O cloudflare-hook.sh -o /dev/null
