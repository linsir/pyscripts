...
if [ ! -f "cloudxns.sh" ];then
    wget https://github.com/linsir/pyscripts/raw/master/le-dns/cloudxns.sh -O cloudxns.sh -o /dev/null
    chmod +x cloudxns.sh
fi

if [ ! -f "cloudxns-hook.sh" ];then
    wget https://github.com/linsir/pyscripts/raw/master/le-dns/cloudxns-hook.sh -O cloudxns-hook.sh -o /dev/null
