...
if [ ! -f "dnspod.sh" ];then
    wget https://github.com/linsir/pyscripts/raw/master/le-dns/dnspod.sh -O dnspod.sh -o /dev/null
    chmod +x dnspod.sh
fi

if [ ! -f "dnspod-hook.sh" ];then
    wget https://github.com/linsir/pyscripts/raw/master/le-dns/dnspod-hook.sh -O dnspod-hook.sh -o /dev/null
